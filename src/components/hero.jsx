import bg from "../assets/hero-graphics.svg";

export default function Hero() {
  return (
    <section className="bg-[radial-gradient(50%_50%_at_50%_50%,#17956D_0%,#0F684C_100%)] pt-32 pb-20 -mt-[92px] md:-mt-[118px] flex justify-center items-center">
